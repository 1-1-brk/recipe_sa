    ...
    <div className="newsletter">
      <div className="newsletter-text">
        <div className="header">
          <h3 className="headline">Deliciously Fake Newsletter</h3>
          <h5 className="subheadline">Discover Mouthwatering Recipes</h5>
        </div>
        {/* <div className="image">
        ...
        <div className="content">
          ...
          <p>
            Are you ready to embark on a culinary adventure? Get ready for a
            tantalizing journey through a world of flavors and recipes that will
            tickle your taste buds!
          </p>
          <p>
            From hearty comfort foods to exotic delights, our fake recipe
            sharing community has it all. Join us and explore imaginative
            recipes that are as delicious as they are fictional.
          </p>
          <p>
            Don't miss out on the fun! Subscribe now to receive mouthwatering
            recipes that exist only in the realm of imagination.
          </p>
          <p></p>
