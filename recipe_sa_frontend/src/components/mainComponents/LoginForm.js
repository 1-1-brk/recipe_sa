          ...
          >
            <li className="nav-item" role="presentation">
              <button
                ...
                id="tab-login"
                style={{
                  background: this.state.active === "login" ? "#ffcc00" : "",
                  color: this.state.active === "login" ? "" : "#444444",
                }}
            ...
            <li className="nav-item" role="presentation">
              <button
                ...
                id="tab-register"
                style={{
                  background: this.state.active === "register" ? "#ffcc00" : "",
                  color: this.state.active === "register" ? "" : "#444444",
                }}
